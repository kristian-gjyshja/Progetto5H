...
if (!isset($_POST['password'], $_POST['email'])) {
    header('Location: public/login/login.php?error=missing_fields');
    exit();
}
...
if (!$row_user) {
    header('Location: public/login/login.php?error=invalid_credentials');
    exit();
}
...
if ($row_user['ruolo'] === 'admin') {
    ...
    session_destroy();
    header('Location: public/login/login.php?error=invalid_role');
    exit();
}
